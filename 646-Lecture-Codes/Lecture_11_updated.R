...
# https://bis.zju.edu.cn/MCA/gallery.html?tissue=Adult-Liver
...
# Idents(mca)=mca$cluster

mca.markers <- FindAllMarkers(mca, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
mca.markers %>%
  group_by(cluster) %>%
