...
For this tutorial, we will be analyzing the a dataset of Peripheral Blood Mononuclear Cells (PBMC) freely available from 10X Genomics. There are 2,700 single cells that were sequenced on the Illumina NextSeq 500. The raw data can be found [here](https://www.dropbox.com/scl/fo/grgpp32x07sb98m98tpyl/h?rlkey=n3mvlowk7adbwhamt0js63b0o&dl=0).
...
pbmc.data <- Read10X(data.dir = "data/PBMC_hg19/")
...
pbmc@assays$RNA$counts[1:15,1:15]
head(pbmc@meta.data)
head(pbmc@meta.data$percent.mt)
boxplot(pbmc@meta.data$percent.mt)
...
pbmc@assays$RNA$count[1:15,1:15]
pbmc@assays$RNA$data[1:15,1:15]
```
...
VlnPlot(pbmc, feature = c("FCGR3A","GNLY"))
DotPlot(pbmc, feature = c("FCGR3A","GNLY"))
```
